...
main(void)
    ...
    printf("size is %d\n",sizeDLL(p));
    printf("value at 4931 is %.2lf\n",getREAL(getDLL(p,4931)));
    printf("setting value at 4931 to 65.60\n");
    freeREAL(setDLL(p,4931,newREAL(65.60)));
    printf("value at 4931 now is %.2lf\n",getREAL(getDLL(p,4931)));
    freeDLL(p);
    return 0;
    }
